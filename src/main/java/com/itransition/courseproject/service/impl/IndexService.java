...
public class IndexService {
    ...
    private static final List<String> INDICES = Arrays.asList(SearchUtil.INDEX);
    ...
    public void recreateIndices(final boolean deleteExisting) {
        final String settings = SearchUtil.loadAsString("static/es-settings.json");
    ...
    private String loadMappings(String indexName) {
        final String mappings = SearchUtil.loadAsString("static/mappings/" + indexName + ".json");
        if (mappings == null) {
